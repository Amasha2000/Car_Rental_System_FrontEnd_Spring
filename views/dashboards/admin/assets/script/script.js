...
function generateVID() {
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle/lastid',
      method: 'get',
      async: true,
      dataType: 'json',
...
function generateVDID() {
  ...
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle_detail/lastid',
      method: 'get',
      async: true,
      dataType: 'json',
      success: function (response) {
...
$('#main-container').on('click', '#btnAddVehicle', function () {
  ...
  if (input_validation(brand) && input_validation(type) && input_validation(fuel_type) && input_validation(transmission_type) && input_validation(no_of_passenger)
      ...
      $.ajax({
          url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle',
          method: 'post',
          async: true,
...
function uploadVehiclePhotos(image, name) {
  ...
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle_detail/upload_images',
      method: 'post',
      async: true,
      processData: false,
      contentType: false,
...
function deleteVehicle() {
  $('#btnDeleteVehicle').click(function () {
      $.ajax({
          url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle_detail/?id=' + $('#txtVDID').val(),
          method: 'DELETE',
          async: true,
          dataType: 'json',
          success: function (response) {
...
function deleteVehiclePhotos(vdid) {
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle_detail/delete_images/?id=' + vdid,
      method: 'delete',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function updateVehicle() {
  $('#btnUpdateVehicle').click(function () {
      ...
      $.ajax({
          url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle_detail',
          method: 'put',
          async: true,
          contentType: 'application/json',
          dataType: 'json',
...
function loadAllDrivers() {
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/driver',
      method: 'get',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function loadAllCustomers() {
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/customer',
      method: 'get',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function setUserImages(user_role, image, img_source) {
  $.ajax({
      type: "GET",
      url: `http://localhost:8080/EasyCarRental_Server-1.0.0/${user_role}/get_image/${image}`,
...
function loadAllRequests() {
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/request',
      method: 'get',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function setBankSlip(image) {
  $.ajax({
      type: "GET",
      url: `http://localhost:8080/EasyCarRental_Server-1.0.0/request/get_image/${image}`,
      beforeSend: function (xhr) {
          xhr.overrideMimeType('text/plain; charset=x-user-defined');
      },
      success: function (result, textStatus, jqXHR) {
...
function confirmRequest() {
  $('#btnReq-Confirm').click(function () {
      ...
      if (validity) {
          ...
          $.ajax({
              url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/request_detail/update_request_message',
              method: 'put',
              async: true,
              contentType: 'application/json',
              dataType: 'json',
...
function addRequestToBooking() {
  $('#btnReq-AddToBooking').click(function () {
      ...
      if (validity) {
          ...
          $.ajax({
              url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/booking',
              method: 'post',
              async: true,
              contentType: 'application/json',
              dataType: 'json',
...
function changeVehicleAvailability(vdid, value) {
  $.ajax({
      url: `http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle_detail/update_availability?id=${vdid}&status=${value}`,
      method: 'put',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function changeDriverAvailability(did) {
  $.ajax({
      url: `http://localhost:8080/EasyCarRental_Server-1.0.0/driver/update_availability?id=${did}`,
      method: 'put',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function deleteAllRequestsWithParent(rid) {
  $.ajax({
      url: `http://localhost:8080/EasyCarRental_Server-1.0.0/request/delete_request?rid=${rid}`,
      method: 'delete',
      async: true,
      success: function (response) {
          alert(response.message);
...
function deleteRequest(rid, vid) {
  $.ajax({
      url: `http://localhost:8080/EasyCarRental_Server-1.0.0/request_detail/delete_request_details?rid=${rid}&vid=${vid}`,
      method: 'delete',
      async: true,
      success: function (response) {
...
function generateDriver_Sdid() {
  $.ajax({
      url: `http://localhost:8080/EasyCarRental_Server-1.0.0/driver_schedule/last_id`,
      method: 'get',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function loadAllDriversSchedule() {
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/driver_schedule',
      method: 'get',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function deleteDriverSchedule() {
  $('#btnDeleteDriverSchedule').click(function () {
      $.ajax({
          url: `http://localhost:8080/EasyCarRental_Server-1.0.0/driver_schedule?id=${$('#sch-SearchDriver').val()}`,
          method: 'delete',
          async: true,
          success: function (response) {
              alert(response.message);
...
function generateVehicle_Sdid() {
  $.ajax({
      url: `http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle_schedule/last_id`,
      method: 'get',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function loadAllVehicleSchedule() {
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle_schedule',
      method: 'get',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function deleteVehicleSchedule() {
  $('#btnDeleteVehicleSchedule').click(function () {
      $.ajax({
          url: `http://localhost:8080/EasyCarRental_Server-1.0.0/vehicle_schedule?id=${$('#sch-SearchVehicle').val()}`,
          method: 'delete',
          async: true,
          success: function (response) {
              alert(response.message);
...
function generateBookingId() {
  $.ajax({
      url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/booking/last_id',
      method: 'get',
      async: true,
      dataType: 'json',
      success: function (response) {
...
function updateBookingDetails() {
  $('#btnBooking-Update').click(function () {
      ...
      $.ajax({
          url: `http://localhost:8080/EasyCarRental_Server-1.0.0/booking_detail`,
          method: 'put',
          async: true,
          contentType: 'application/json',
          data: JSON.stringify({
...
function updateBookingTotalFee(bid, fee) {
  $.ajax({
      url: `http://localhost:8080/EasyCarRental_Server-1.0.0/booking?id=${bid}&fee=${fee}`,
      method: 'put',
      async: true,
      success: function (response) {
          loadAllBookings();
