            ...
            success: function (response) {
                try {
                    if (response.data.role === 'driver') {
                        //get driver data
                        $.ajax({
                            url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/driver/get/' + response.data.uid,
                            method: 'get',
                            dataType: 'json',
                            success: function (response) {
                                ...
                                $.ajax({
                                    method: 'GET',
                                    async: true,
                                    url: 'http://localhost:8080/EasyCarRental_Server-1.0.0/get/'+driver_id,
                                    dataType: 'json',
                                    success: function (response) {
